    ...
    public class MemoryCacheManager : ICacheManager
    {
        ...
        public void RemoveByPattern(string pattern)
        {
            ...
            if (cacheEntriesFieldCollectionDefinition != null)
            {
                ...
                var entriesCollectionValueCollection = coherentStateValueCollection.GetType().GetProperty("EntriesCollection", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);     //bellekteki entries collection ı bul.
            ...
            var regex = new Regex(pattern, RegexOptions.Singleline | RegexOptions.Compiled | RegexOptions.IgnoreCase);                    //bu iki satır verilen kurallar.
            var keysToRemove = cacheCollectionValues.Where(d => regex.IsMatch(d.Key.ToString())).Select(d => d.Key).ToList();

            foreach (var key in keysToRemove)        //uyan kuralları buraya atıyor ve siliyor.
            {
                _memoryCache.Remove(key);
            }
        }
